...
| git branch -d [branchname]                         | to delete a local branch; The -D option is an alias for --delete --force, which deletes the branch "irrespective of its merged status." [https://stackoverflow.com/questions/2003505/how-do-i-delete-a-git-branch-locally-and-remotely](https://stackoverflow.com/questions/2003505/how-do-i-delete-a-git-branch-locally-and-remotely)  |
...
| git checkout --track -b git-test origin/git-test   | checkout a new branch such that it tracks the remote branch as well.  [https://stackoverflow.com/questions/4878249/how-do-i-change-the-remote-a-git-branch-is-tracking](https://stackoverflow.com/questions/4878249/how-do-i-change-the-remote-a-git-branch-is-tracking)   [https://stackoverflow.com/questions/10002239/difference-between-git-checkout-track-origin-branch-and-git-checkout-b-branch](https://stackoverflow.com/questions/10002239/difference-between-git-checkout-track-origin-branch-and-git-checkout-b-branch) |
|                                                    |      |
